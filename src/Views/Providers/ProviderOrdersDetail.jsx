      ...
      <div className="w-full p-4 bg-[#1e2022] rounded-xl">
        <div className="flex justify-between items-center p-4">
          ...
          <select
            name=""
            id=""
            className="px-4 py-2 focus:border-blue-400 outline-none bg-black border border-slate-700 rounded-xl text-white"
          >
          ...
          <div className="flex flex-wrap">
            <div className="w-[30%]">
              <div className="pr-3 text-white text-lg">
                ...
                <div className="mt-4 flex flex-col gap-4 bg-black rounded-xl">
            ...
            {/* <div className="w-[70%] ">
              <div className="pl-3">
                <div className="mt-4 flex flex-col bg-black rounded-xl p-4">
                  <div className="text-white">
                    <div className="flex justify-start items-center gap-3">
...
export default ProviderOrdersDetail;
