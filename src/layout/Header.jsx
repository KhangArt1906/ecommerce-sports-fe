...
const Header = ({ showSidebar, setShowSidebar }) => {
  return (
    <div className="fixed top-0 left-0 w-full py-5 px-2 lg:px-7 z-40">
      ...
      <div
        className="ml-0 lg:ml-[260px] rounded-md h-[65px] flex 
      ...
      >
        ...
        <div className="hidden md:block">
          <input
            type="text"
            className="px-3 py-2 outline-none border bg-transparent border-slate-700 rounded-md text-white focus:border-indigo-300 overflow-hidden"
            name="search"
            placeholder="Search"
          />
        </div>
